...
(slideViewDidLoad = function(container,id){	
	...
	$("#canvasId").append("<canvas id='childCanvas' width='1108' height='88' style='position:absolute;top:245px;left:-1px;'></canvas>");	
	...
	var textArray = [
		...
		{compId:"ID_s1_txt24", x:"100", y:"326", width:"0", expand:"right", align:"left" ,size:"10" ,class:"orangeCallOut"}
