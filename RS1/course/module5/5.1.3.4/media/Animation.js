...
(lib.lazy_txt = function() {
	...
	// Layer 1
	this.text = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_txt04", width:"100", expand:"up+down",size:10});
...
(lib.bublle1 = function() {
	...
	// Layer 1
	this.text_15 = new BubbleComp({x:"0",y:"0",width:"220",size:"10",compId:"ID_bubble_01",align:"center",tailPosition:"6",tailFlip:"1",extend:"up+down"});
...
//	this.text_15.lineHeight = 13;
	this.text_15.setTransform(0,10);
