...
//drawRect(legendObj.color,Number(legendObj.x),Number(legendObj.y),Number(legendObj.width),Number(legendObj.height),Number(legendObj.br));
	...
	topCont=  drawRect("#0197D6",0,20,420,28.4,10); 
	topCont.cursor="null";	
	topCont.alpha=0.5;
	...
	{	 
		...
		//drawRoundRect(rectX,rectY,rectW,rectH,rectBr)		
		slideContainer.addChild(rectangle);
		//	whiteCont.shape.graphics.clear();
		 
	}
		
	var tlManifest = [{id:"TimelineLayoutXml", src:'media_6.1.1.1_layout.xml'},
	...
	{		
		...
		{
			var text = new createjs.Text(String(minVal+i), "bold 12px Arial", "#393536");
